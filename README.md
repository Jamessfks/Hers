...
[![Version](https://img.shields.io/badge/version-2.0.7-4b3f9e?style=flat-square&labelColor=22204d)](CHANGELOG.md)
...
[![Tests](https://img.shields.io/badge/tests-538%20passing-4b3f9e?style=flat-square&labelColor=22204d)](#working-on-it)
...
```bash
npm run check      # typecheck + 538 tests, ~20s. No API key, no network. The gate.
